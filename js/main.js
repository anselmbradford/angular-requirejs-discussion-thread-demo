...
define("vendor/bower_components/almond/almond", function(){});
...
/*
 ...
 License: MIT
*/
(function(Q,T,s){function z(b){return function(){var a=arguments[0],c,a="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.2.15/"+(b?b+"/":"")+a;for(c=1;c<arguments.length;c++)a=a+(1==c?"?":"&")+"p"+(c-1)+"="+encodeURIComponent("function"==typeof arguments[c]?arguments[c].toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof arguments[c]?"undefined":"string"!=typeof arguments[c]?JSON.stringify(arguments[c]):arguments[c]);return Error(a)}}function $a(b){if(null==b||Aa(b))return!1;
...
define('app/app',['angular'], function (angular)
{
    ...
    return angular.module('wikimedia-discuss', []);
});
...
define('app/controllers/discussionController',['app/app'], function (app)
{
...
define('app/directives/treeDirective',['app/app'], function (app) {
